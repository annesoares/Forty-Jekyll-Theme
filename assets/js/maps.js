function initialize() {
  ...
  var WTMs = [
      ...
      ['WTM Maringá', -23.4209995,	-51.933055800000034],
      ['WTM Brasília', -15.7942287,	-47.882165799999996],
      ['WTM Lavras', -21.2484875,	-45.001374699999985],
      ['WTM Fortaleza', -3.7318616,	-38.5266704]
  ];
  ...
  var infoWindowContent = [
      ...
      '</div>'],
      ['<div class="info_content">' +
      '<strong>WTM Maringá</strong><br>' +
      '<a href="https://sites.google.com/site/gdgmaringa/home">Site do GDG</a>' +
      '</div>'],
      ['<div class="info_content">' +
      '<strong>WTM Brasília</strong><br>' +
      '<a href="https://www.facebook.com/gdgbrasilia/">Facebook do GDG</a>' +
      '</div>'],
      ['<div class="info_content">' +
      '<strong>WTM Lavras</strong><br>' +
      '<a href="https://www.facebook.com/GDGLavras/">Facebook do GDG</a>' +
      '</div>'],
      ['<div class="info_content">' +
      '<strong>WTM Fortaleza</strong><br>' +
      '<a href="https://www.facebook.com/groups/gdgfortaleza/">Facebook do GDG</a>' +
      '</div>']
  ];
